...
Module modApp
    ...
    Public Const DeveloperProgrammer As String = "SYLVSTER R. BELONIO"
    Public Const LeadProgrammer As String = "ZHALICK O. DARANGINA"

    Public Sub setAssemblyInfo(Optional ByVal AssemmblyInfo As System.Reflection.Assembly = Nothing)
        asm = AssemmblyInfo
    End Sub
...
#End Region
    ...
    Friend Function AssemblyLastWriteTime(ByVal a As System.Reflection.Assembly) As DateTime
        Try

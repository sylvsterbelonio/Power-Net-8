...
Public Class MyStatusStripExtension
    Inherits StatusStrip


    Private Renderers As New myRenderer_StatusStrip
    ...
    Private LabelBackColor As Color = Color.White
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        If _Background_Style = BackStyle.VerticalGradient Then
            ...
            'draw grip style
            '3
            If MyBase.GripStyle = ToolStripGripStyle.Visible Then
                e.Graphics.DrawLine(Pens.White, Me.Width - 3, Me.Height - 2, Me.Width - 4, Me.Height - 2)
                e.Graphics.DrawLine(Pens.White, Me.Width - 3, Me.Height - 3, Me.Width - 4, Me.Height - 3)

                e.Graphics.DrawLine(Pens.White, Me.Width - 7, Me.Height - 2, Me.Width - 8, Me.Height - 2)
                e.Graphics.DrawLine(Pens.White, Me.Width - 7, Me.Height - 3, Me.Width - 8, Me.Height - 3)

                e.Graphics.DrawLine(Pens.White, Me.Width - 11, Me.Height - 2, Me.Width - 12, Me.Height - 2)
                e.Graphics.DrawLine(Pens.White, Me.Width - 11, Me.Height - 3, Me.Width - 12, Me.Height - 3)
                '2
                e.Graphics.DrawLine(Pens.White, Me.Width - 3, Me.Height - 6, Me.Width - 4, Me.Height - 6)
                e.Graphics.DrawLine(Pens.White, Me.Width - 3, Me.Height - 7, Me.Width - 4, Me.Height - 7)

                e.Graphics.DrawLine(Pens.White, Me.Width - 7, Me.Height - 6, Me.Width - 8, Me.Height - 6)
                e.Graphics.DrawLine(Pens.White, Me.Width - 7, Me.Height - 7, Me.Width - 8, Me.Height - 7)
                '1
                e.Graphics.DrawLine(Pens.White, Me.Width - 3, Me.Height - 10, Me.Width - 4, Me.Height - 10)
                e.Graphics.DrawLine(Pens.White, Me.Width - 3, Me.Height - 11, Me.Width - 4, Me.Height - 11)


                '3
                e.Graphics.DrawLine(New Pen(unselect_font_color), Me.Width - 4, Me.Height - 3, Me.Width - 5, Me.Height - 3)
                e.Graphics.DrawLine(New Pen(unselect_font_color), Me.Width - 4, Me.Height - 4, Me.Width - 5, Me.Height - 4)

                e.Graphics.DrawLine(New Pen(unselect_font_color), (Me.Width - 7) - 1, (Me.Height - 2) - 1, (Me.Width - 8) - 1, (Me.Height - 2) - 1)
                e.Graphics.DrawLine(New Pen(unselect_font_color), (Me.Width - 7) - 1, (Me.Height - 3) - 1, (Me.Width - 8) - 1, (Me.Height - 3) - 1)

                e.Graphics.DrawLine(New Pen(unselect_font_color), Me.Width - 12, Me.Height - 3, Me.Width - 13, Me.Height - 3)
                e.Graphics.DrawLine(New Pen(unselect_font_color), Me.Width - 12, Me.Height - 4, Me.Width - 13, Me.Height - 4)
                '2
                e.Graphics.DrawLine(New Pen(unselect_font_color), Me.Width - 4, Me.Height - 7, Me.Width - 5, Me.Height - 7)
                e.Graphics.DrawLine(New Pen(unselect_font_color), Me.Width - 4, Me.Height - 8, Me.Width - 5, Me.Height - 8)

                e.Graphics.DrawLine(New Pen(unselect_font_color), Me.Width - 8, Me.Height - 7, Me.Width - 9, Me.Height - 7)
                e.Graphics.DrawLine(New Pen(unselect_font_color), Me.Width - 8, Me.Height - 8, Me.Width - 9, Me.Height - 8)
                '1
                e.Graphics.DrawLine(New Pen(unselect_font_color), Me.Width - 4, Me.Height - 11, Me.Width - 5, Me.Height - 11)
                e.Graphics.DrawLine(New Pen(unselect_font_color), Me.Width - 4, Me.Height - 12, Me.Width - 5, Me.Height - 12)
            End If
...
#End Region
    ...
    Public Property My_Label_BackColor() As Color
        Get
...
Public Class myRenderer_StatusStrip
...
#Region "GLOBAL VARIABLES"
    ...
    Public LabelBackColor As Color
...
#End Region
    ...
    Private Sub DrawGradientMenuItem2(ByVal g As Graphics, ByVal item As ToolStripItem, ByVal colors As GradientColor)
        Dim backRect As Rectangle = New Rectangle(-1, -1, item.Bounds.Width + 2, item.Bounds.Height + 2)
    ...
    Protected Overrides Sub OnRenderToolStripStatusLabelBackground(ByVal e As System.Windows.Forms.ToolStripItemRenderEventArgs)
        e.Graphics.FillRectangle(Brushes.Red, e.Item.Bounds)

        Dim b As ToolStripStatusLabel = e.Item

        If b.Selected Then
            'e.Graphics.FillRectangle(New SolidBrush(standard_highlight_backcolor), New Rectangle(-1, -1, e.Item.Bounds.Width + 2, e.Item.Bounds.Height + 2))
        Else
            e.Graphics.FillRectangle(New SolidBrush(LabelBackColor), New Rectangle(1, 1, e.Item.Bounds.Width - 1, e.Item.Bounds.Height - 1))
        End If

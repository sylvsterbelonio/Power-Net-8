...
<ToolboxItem(True), ToolboxBitmap(GetType(MyTextboxExtension), "CustomObjects.textbox.bmp")> _
Public Class MyTextboxExtension
    Inherits TextBox
...
#End Region
    ...
    Private Sub BorderStyleChangeds(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.BorderStyleChanged
        If Me.BorderStyle <> Forms.BorderStyle.FixedSingle Then
            Me.BorderStyle = Forms.BorderStyle.FixedSingle
        End If
    End Sub

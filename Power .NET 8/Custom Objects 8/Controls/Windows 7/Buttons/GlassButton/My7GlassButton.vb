...
<ToolboxItem(True), ToolboxBitmap(GetType(Button)), ToolboxItemFilter("System.Windows.Forms"), Description("Display the Bar that indicates the Progress of Operation.")> _
<DefaultEvent("Click"), DefaultProperty("Text")> _
Public Class My7GlassButton
...
#Region "   Mouse Events"
    ...
    Protected Overrides Sub OnMouseEnter(ByVal e As System.EventArgs)
        ...
        i_mode = 1
        xmouse = PointToClient(Windows.Forms.Cursor.Position).X
        mouse = True
        A0 = 200
        If i_factor = 0 Then
            R0 = _onColor.R
    ...
    Protected Overrides Sub OnMouseDown(ByVal mevent As System.Windows.Forms.MouseEventArgs)
        ...
        i_mode = 2
        xmouse = PointToClient(Windows.Forms.Cursor.Position).X
        ymouse = PointToClient(Windows.Forms.Cursor.Position).Y
        mouse = True
    End Sub
    ''' <summary>
        ...
        Else
            ...
            If (_keeppressed) Then
                ...
                For Each _control As Control In Me.Parent.Controls
                    If _control.Name <> Me.Name And TypeOf (_control) Is My7GlassButton = True Then
                        CType(_control, My7GlassButton)._ispressed = False
                        CType(_control, My7GlassButton).UpdateMouseLeave()
                    End If
                Next
            End If
        End If

...
Public Class MyContextMenuStrip
    ...
    Private select_font_color As Color = Color.White
    ...
    Private Renderers As New myRenderer_ContextMenuStrip
    ...
    Protected Overrides Sub OnOpened(ByVal e As System.EventArgs)
        ...
        Dim wind As New Form
        wind.ControlBox = False
        wind.Text = ""
...
Public Class myRenderer_ContextMenuStrip
    ...
    Public hover_select_image As Image = Nothing

...
<System.Diagnostics.DebuggerStepThrough()> _
Friend Class LabelBlendItemsConverter : Inherits ExpandableObjectConverter
...
<System.Diagnostics.DebuggerStepThrough()> _
Public Class LabelBlendTypeEditor
    ...
    Public Overloads Overrides Function EditValue(ByVal context As ITypeDescriptorContext, ByVal provider As IServiceProvider, ByVal value As Object) As Object
        If (Not context Is Nothing) And (Not provider Is Nothing) Then
            ...
            If Not editorService Is Nothing Then
                ...
                Using dropDownEditor As LaBELDropdownColorBlender = New labelDropdownColorBlender(editorService)
                    ...
                    If context.Instance.GetType Is GetType(gLabel) Then
                        ...
                        'Instance = CType(CType(context.Instance, gLabel).CurrControl, gLabel)
                    End If
